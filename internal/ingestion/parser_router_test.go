...
func TestParser(t *testing.T) {
	tests := []struct {
		...
		{"HL7", FormatHL7, json.RawMessage(`"MSH|^~\\&|LAB|HOSP"`), false},
		{"X12", FormatX12, json.RawMessage(`"ISA*00*00*ZZ*SENDER"`), false},
		{"FHIR", FormatFHIR, json.RawMessage(`{"resourceType":"Patient","id":"123"}`), false},
	}
