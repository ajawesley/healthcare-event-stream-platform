...
func TestX12Normalizer_MissingSegments(t *testing.T) {
	tests := []struct {
		...
		{"missing ISA", "GS*HC*X*Y~ST*837*1~", ErrX12MissingISA},
		{"missing GS", "ISA*00*00~ST*837*1~", ErrX12MissingGS},
		{"missing ST", "ISA*00*00~GS*HC*X*Y~", ErrX12MissingST},
		{"missing NM1 IL", "ISA*00*00~GS*HC*X*Y~ST*837*1~CLM*1~", ErrX12MissingNM1IL},
		{"missing CLM", "ISA*00*00~GS*HC*X*Y~ST*837*1~NM1*IL*1*Doe*John~", ErrX12MissingCLM},
	}
